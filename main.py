...
class GenerateReport:
    ...
    def get_best_item(self):
        try:
            ...
            print(f"Problem with sorting items | {e}")
            return None
...
class AmazonAPI:
    def __init__(self, search_term, filters, base_url, currency):
        ...
        set_chrome_profile(options, CHROME_PROFILE_PATH)
        set_logging_off(options)
    ...
    def get_products_links(self):
        ...
        try:
            results = result_list[0].find_elements(
                ...
                # '//*[@id="search"]/span[2]/div/div[4]/div/div/'
                # '//*[@id="search"]/span[2]/div/div[4]/div/div/span/div/div[1]/span/a'
                # '//*[@id="search"]/span[2]/div/div[5]/div/div/span/div/div[1]/span/a'
            )
            ...
            print(f"Didn't get any products... | {e}")
            return links
    ...
    def get_title(self):
        try:
            ...
            print(f"Can't get title of a product - {self.driver.current_url} | {e}")
            return None
    ...
    def get_seller(self):
        try:
            ...
            print(f"Can't get seller of a product - {self.driver.current_url} | {e}")
            return None
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                ...
                print(f"Can't get price of a product - {self.driver.current_url} | {e}")
                return None
